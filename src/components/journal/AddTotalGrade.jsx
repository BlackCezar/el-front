...
export default function AddGrade({isOpen, onClose, object, setObject, action, students}) {
    ...
    return (<Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
            ...
            <ModalHeader> {object._id ? 'Изменить оценку' : 'Добавить итоговую оценку'} </ModalHeader>
            <ModalCloseButton />
            <ModalBody>
                ...
                <FormControl as='fieldset' mb={3}>
                    ...
                    <Select placeholder='Выберите урок' id="lesson" value={object.date} onChange={ev => setObject({...object, date: ev.target.value})}>
